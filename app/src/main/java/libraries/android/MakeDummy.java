...
public class MakeDummy {
    ...
    public static TableLayout table(TableRow... tableRows) {
        return table(tableRows[0].getContext(),tableRows);
    }
    ...
    public static TableRow row(View... views) {
        return row(views[0].getContext(),views);
    }
}
